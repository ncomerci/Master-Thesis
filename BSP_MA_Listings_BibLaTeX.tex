...
\outlineEng{The Internet is going through a transition stage thanks to blockchain technology, where users will no longer be mere consumers and creators of content but will become owners of their information. This is due to multiple demonstrations of abuse of trust by centralized entities towards people. The trigger for this was the collapse of the US housing market in 2008; a year later, blockchain was introduced, with Bitcoin as the first use case.

Thanks to this crisis of confidence and the opportunities provided by this emerging technology, new ideas have surfaced, one of them being decentralized governance. Of course, this implies a lot of challenges, many of which are not yet solved, or perhaps not in the most optimal way. One of them is access to information. In an organization where decisions are no longer made by a few and all actors start to participate in them, free access to information is of vital importance.

This thesis provides an approach to solving the problem of free access to information for the participants of a Decentralized Autonomous Organization. For this, the starting point was the fact that blockchain data is public and available to anyone, and the sources from which this information could be extracted were identified. Then, a series of scripts were developed to extract the data automatically and make it available in more user-friendly formats such as JSON and CSV. Finally, a metrics dashboard was created that uses these files as a source and allows for drawing conclusions about the DAO status in a very simple visual way.


It is also worth pointing out that these files are available for third-party applications to consume and build on top of them.}
...
Secondly to my team at Decentraland DAO for trusting me, giving me the possibility to grow professionally and allowing me to demonstrate my ability to face the different challenges that arise on a daily basis. \\
