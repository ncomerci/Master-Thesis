...
Figure \ref{fig:vote_weight} shows by month, the average weight of each vote in the final outcome of the proposals. The lower the percentage, the more distributed the voting power.
\begin{figure}[H]
  \centering
