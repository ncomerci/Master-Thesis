...
\place{Vienna}
\outline{Mit dem Aufkommen der Distributed-Ledger-Technologie (DLT), die üblicherweise als Blockchain-Technologie bezeichnet wird, befindet sich das Internet in einer Übergangsphase, in der die Nutzer nicht mehr nur Verbraucher und Ersteller von Inhalten sind, sondern Eigentümer ihrer Daten werden. Dies ist auf mehrere Vorfälle in jüngster Zeit zurückzuführen, bei denen das Vertrauen der Verbraucher von zentralisierten Organisationen missbraucht wurde. Ein Fall, der die "Große Rezession" im Jahr 2008 auslöste, war der Zusammenbruch des US-Immobilienmarktes. Im selben Jahr wurde das Konzept der Blockchain eingeführt, wobei Bitcoin der erste Anwendungsfall war.

Nach dieser Vertrauenskrise und den Möglichkeiten, die die aufkommende Blockchain-Technologie bietet, sind innovative Ideen aufgetaucht: eine von vielen ist die "dezentrale Verwaltung". Das derzeitige Anfangsstadium bringt viele Herausforderungen mit sich, von denen viele noch gar nicht oder vielleicht nicht optimal gelöst wurden. Eine davon ist der Zugang zu Daten in einem verteilten Ökosystem: In einer Organisation, in der Entscheidungen nicht mehr von einem zentralisierten Entscheidungsträger, sondern von der Gemeinschaft getroffen wird, ist ein offener Zugang zu relevanten Daten, auf denen gemeinsame Entscheidungen beruhen, von entscheidender Bedeutung.

Diese Arbeit bietet einen Ansatz zur Lösung des Problems des offenen Zugangs zu Informationen für die Teilnehmer einer Dezentralen Autonomen Organisation (DAO). Per Definition sind die in einem Blockchain-System gespeicherten Daten öffentlich und für jedermann zugänglich. Außerdem müssen die Quellen, aus denen die Informationen stammen, identifizierbar sein. Es wurde eine Reihe von Skripten entwickelt, um die gegebenen Blockchain-Daten automatisch zu verarbeiten und umzuwandeln und sie in maschinenlesbaren Formaten wie JSON und CSV zur Verfügung zu stellen. Schließlich wurde ein benutzerfreundliches Dashboard erstellt, um die umgewandelten Daten zu visualisieren, so dass Menschen Rückschlüsse auf den Status der DAO ziehen können.

Gemäß dem Ethos der Blockchain werden die extrahierten Daten und Visualisierungen als "Open Data" veröffentlicht und sind für Anwendungen von Drittanbietern verfügbar, die sie nutzen und darauf aufbauen können.}
