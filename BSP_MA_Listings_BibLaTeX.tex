...
To date there are about 140,570 transactions between all DAO wallets and, discounting internal transfers between wallets, only 67 transactions remained untagged. In other words, more than 99.95\% of the transactions could be classified into categories.
